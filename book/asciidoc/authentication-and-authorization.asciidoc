...
1. Read on [Google Developers Help](https://developers.google.com/identity/protocols/OAuth2) how to obtain OAuth 2.0 credentials such as a client ID and client secret that are known to both Google and your application.
