...
String interpolation works slightly differently in Julius. You'll need to use
the `rawJS` function to get a string that isn't wrapped in double-quotes. Don't
forget to import that function where necessary.
