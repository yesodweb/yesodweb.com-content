...
NOTE: We're in the process of upgrading from cabal to
link:https://github.com/commercialhaskell/stack#readme[stack], a more modern
replacement for cabal. Expect the instructions here to change in the coming
weeks.
