...
stack --resolver lts-11.3 runghc --package classy-prelude-conduit $DIR/extract-code.hs
(cd extracted && stack --resolver lts-11.3 ghc --package classy-prelude-yesod -- --make *.hs)
